...
class TestSpeakerDiarization:
    ...
    @patch("src.transcriber.torch")
    @patch("src.transcriber.whisper")
    def test_perform_speaker_diarization_without_pipeline(
    ...
    @patch("src.transcriber.torch")
    @patch("src.transcriber.whisper")
    def test_perform_speaker_diarization_overlap_detection(
        self, mock_whisper, mock_torch
    ):
    ...
    @patch("src.transcriber.torch")
    @patch("src.transcriber.whisper")
    def test_perform_speaker_diarization_exception_handling(
        self, mock_whisper, mock_torch
    ):
    ...
    @patch("src.transcriber.torch")
    @patch("src.transcriber.whisper")
    def test_perform_speaker_diarization_counts_unique_speakers(
        self, mock_whisper, mock_torch
    ):
